...
export default class Table extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (this.props !== nextProps) {
            // 是否添加表头
            if (this.props.selector.type === 'checkbox' && this.fields[0].type !== 'checkbox') {
                nextProps.fields.unshift({
                    type: 'checkbox'
                })
            }
            if (this.props.selector.type === 'radio' && this.field[0].type !== 'radio') {
                nextProps.fields.unshift({
                    type: 'radio'
                })
            }
            ...
            this.setState({
                ...
                datas: _.cloneDeep(nextProps.datas)
            })
        }
    }
