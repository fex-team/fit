...
export default class Table extends React.Component {
    ...
    updateTable(page, params) {
        ...
        if (this.props.get.url === '') {
            ...
            $.ajax({
                ...
                data: this.props.get.beforeSend(params || this.searchOpts, page || this.state.currentPage, this.prevResponse, this.extendInfo)
            }).done((res)=> {
    ...
    // 查询按钮点击
    handleSearch(params) {
        Object.assign(this.searchOpts, params)
        this.updateTable(1)
    }
