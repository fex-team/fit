(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("fit-style"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "fit-style"], factory);
	else if(typeof exports === 'object')
		exports["fit-modal"] = factory(require("react"), require("fit-style"));
	else
		root["fit-modal"] = factory(root["react"], root["fit-style"]);
	    ...
	    _createClass(Checkbox, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'lib-pc-modal-src-modal modal fade in', onClick: this.handleOutClick.bind(this), tabIndex: '-1',
	                    style: { display: this.props.show ? 'block' : null } },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'modal-dialog', onClick: this.handleModalClick.bind(this) },
	                    _react2.default.createElement(
	                        'div',
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'modal-body', style: { marginTop: this.props.title === '' ? 20 : null } },
	                            this.props.children
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            ...
	                            _react2.default.createElement(
	                                'button',
	                                { type: 'button', onClick: this.handleCancel.bind(this), className: 'btn btn-secondary' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".lib-pc-modal-src-modal {\n  overflow-x: hidden;\n  overflow-y: auto;\n  background: rgba(0, 0, 0, 0.35); }\n\n.lib-pc-modal-src-modal button.close {\n  outline: none; }\n", ""]);
