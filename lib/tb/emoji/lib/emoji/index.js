...
var Submit = (function (_React$Component) {
    ...
    _createClass(Submit, [{
        ...
        value: function render() {
            ...
            var style = Object.assign({}, _style2.default, this.props.style);
                ...
                case 'default':
                    EmojiContent = _emojiList2.default.map(function (item, index) {
                        ...
                        return _react2.default.createElement(
                            'div',
                            { key: index,
                                onClick: _this2.handleEmojiClick.bind(_this2, item),
                                style: style.emojiContainer },
                            _react2.default.createElement('div', { style: Object.assign({}, style.emojiItem, emojiBg, emojiPosition) })
                        );
                    });
                    break;
                case 'text':
            ...
            return _react2.default.createElement(
                ...
                !this.props.control ? _react2.default.createElement(
                    'div',
                    { onClick: this.handleOuterButtonClick.bind(this) },
                    '按钮'
                ) : null,
                _react2.default.createElement(
                    'div',
                    { style: Object.assign({}, style.modalContainer, modalContainerVisible, modalContainerCustom) },
                    _react2.default.createElement(
                        'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { onClick: this.handleChangeType.bind(this, 'default'),
                                style: Object.assign({}, style.addonItem, this.state.type === 'default' ? style.addonItemActive : null) },
                            '默认'
                        ),
                        _react2.default.createElement(
                            'div',
                            { onClick: this.handleChangeType.bind(this, 'text'),
