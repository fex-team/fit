    ...
    render() {
        ...
        case 'default':
            EmojiContent = emojiArray.map((item, index)=> {
                ...
                return (
                    <Tappable key={index}
                         onTap={this.handleEmojiClick.bind(this,item)}
        ...
        return (
            <div style={style.container}>
                {!this.props.control ?
                    <Tappable onTap={this.handleOuterButtonClick.bind(this)}>按钮</Tappable> : null
                }
                <div style={Object.assign({},style.modalContainer,modalContainerVisible,modalContainerCustom)}>
                    ...
                    <div style={style.addonContainer}>
                        <Tappable onTap={this.handleChangeType.bind(this,'default')}
                             style={Object.assign({},style.addonItem,this.state.type==='default'?style.addonItemActive:null)}>
                            默认
                        </Tappable>
                        <Tappable onTap={this.handleChangeType.bind(this,'text')}
