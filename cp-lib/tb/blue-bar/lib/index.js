...
var _tbShare = require('tb-share');

var _tbShare2 = _interopRequireDefault(_tbShare);
...
var Bluebar = function (_React$Component) {
    ...
    _createClass(Bluebar, [{
        ...
        value: function render() {
            ...
            var rightOptions = this.props.rightOptions;

            var rightTools = undefined;

            if (rightOptions.length == 1) {
                var op = rightOptions[0];

                if (op.type === 'share') {
                    rightTools = _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement('img', { onClick: this.onShare.bind(this), src: _share2.default }),
                        _react2.default.createElement(_tbShare2.default, { hide: this.state.shareHide, title: op.title, desc: op.desc, pic: op.pic, url: op.url })
                    );
                }
            }
