...
var Submit = function (_React$Component) {
    ...
    _createClass(Submit, [{
        ...
        value: function componentWillMount() {
            var tbSubmitContent = (0, _store2.default)('tbSubmitContent');
            if (tbSubmitContent) {
                _store2.default.remove('tbSubmitContent');
                this.setState({
                    content: tbSubmitContent
                });
            }
        }
    }, {
        ...
        value: function handleSubmit(event) {
            ...
            // 将要发送的内容存在本地存储
            (0, _store2.default)('tbSubmitContent', this.state.content);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.props.useEmoji ? _react2.default.createElement(
