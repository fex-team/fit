...
import BlurBarSource from '../../../../lib/tb/blue-bar/src/blur-bar'
import BlurBarSourceCode from 'text!../../../../lib/tb/blue-bar/src/blur-bar'
        ...
        case 'document':
            Content = (
                <div>
                    ...
                    <div style={docStyle}>
                        <CodeDoc code={BlurBarSourceCode}
                                 instance={BlurBarSource}/>
                    </div>
