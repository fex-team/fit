...
const MainRouter = (
    <Router history={browserHistory}>
        ...
        <Route path="/designer"
               component={Designer}/>
        <Route path="/components/write-standard"
               component={ComponentsWriteStandard}/>
        <Route path="/components/doc"
               component={ComponentsDoc}/>
        <Route path="/components/change-log"
               component={ComponentsChangeLog}/>
