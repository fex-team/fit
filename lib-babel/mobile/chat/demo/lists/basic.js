...
var Demo = (function (_React$Component) {
    ...
    _createClass(Demo, [{
        key: 'handleNameRender',
        value: function handleNameRender() {
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_fitenChat2.default, { name: 'fit',
                    content: 'fit组件很好用',
                    portrait: 'http://himg.bdimg.com/sys/portrait/item/052ee28496e7bfb1e7be8ae7bebde5a4a7e7a9ba4620.jpg' }),
                _react2.default.createElement(_fitenChat2.default, { position: 'right',
                    name: 'fiten',
