    ...
    _createClass(Demo, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { style: { display: 'flex' } },
                _react2.default.createElement(_fitDatepicker.DateRange, { onChange: this.handleChange.bind(this) }),
                _react2.default.createElement(_fitDatepicker.DateRange, { value: defaultValue })
            );
        }
    }]);
