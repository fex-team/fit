    ...
    _createClass(Table, [{
        ...
        value: function updateTable(page) {
            ...
            if (this.props.get.url === '') {
                ...
                (function () {
                    var postData = _this4.props.get.beforeSend(mergedSearchOpts, page || _this4.state.currentPage, _this4.prevResponse, _this4.extendInfo);

                    _jquery2.default.ajax({
                        url: _this4.props.get.url,
                        method: _this4.props.get.method,
                        dataType: _this4.props.get.dataType || 'json',
                        ...
                        // 手动调用翻页组件
                        _this4.refs.pagination && _this4.refs.pagination.jump(page || _this4.state.currentPage);
                        ...
                        _this4.setState({
                            ...
                            _this4.props.onTableUpdate(newDatas, postData);
                        });
                    });
                })();
            }
        ...
        value: function render() {
            ...
            var finder = _props.finder;
            var finderSelector = _props.finderSelector;
            var extend = _props.extend;

            var others = _objectWithoutProperties(_props, ['className', 'responsive', 'del', 'title', 'add', 'fields', 'finder', 'finderSelector', 'extend']);
            ...
            var TrTd = this.state.datas.map(function (tr, index) {
                ...
                // 如果有删除功能,右侧新增一列
                if (del.url !== '' && _this11.state.showColDeleteButton) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        title,
                        add.url === '' ? null : _react2.default.createElement(_add2.default, { fields: fields,
                            opts: add,
                    ...
                    _lodash2.default.isEmpty(finder) ? null : finderSelector ? _react2.default.createElement(
                        _fitRenderTo2.default,
                        { selector: finderSelector },
                        _react2.default.createElement(_finder2.default, { onSearch: this.handleSearch.bind(this),
                            finder: finder })
                    ) : _react2.default.createElement(_finder2.default, { onSearch: this.handleSearch.bind(this),
                        finder: finder }),
                    Table,
                    _lodash2.default.isEmpty(this.state.paginOpts) && _lodash2.default.isEmpty(extend()) ? null : _react2.default.createElement(
                        'div',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        null,
                        del.alert(this.currentDeleteColInfo || {})
                    )
                )
            );
        }
...
Table.defaultProps = {
    ...
    // @desc 表格数据更新的回调
    onTableUpdate: function onTableUpdate() {},
